...
# Performance on devtest of masc dataset
# [Average]    P: 74.26   R:  9.20   F1: 16.38   EX:  6.06
class PCFGParser(Parser):
    ...
    def train(self, train_trees):
        ...
        for i in xrange(len(train_trees)):
    ...
    # CKY algorithm with unary extension
    def get_best_parse(self, sentence):
        """
        Should return a Tree.
...
class Grammar:
    ...
    def __init__(self, train_trees):
        ...
        self.binary_rules_by_right_child = collections.defaultdict(
                lambda: [])
        self.binary_rules_by_both_child = collections.defaultdict(
    ...
    def add_binary(self, binary_rule):
        ...
        self.binary_rules_by_right_child[binary_rule.right_child].\
                append(binary_rule)
        self.binary_rules_by_both_child[binary_rule.left_child][binary_rule.right_child].\
                append(binary_rule)
    ...
    def get_binary_rules_by_both_child(self, left_child, right_child):
        return self.binary_rules_by_both_child[left_child][right_child]
...
if __name__ == '__main__':
    ...
    opt_parser.add_option("-t", dest="test", action="store_true")
    ...
    if options["test"] == None:
        ...
        while True:
            ...
            guessed_tree = parser.get_best_parse(line.split(" "))
            print Trees.PennTreeRenderer.render(guessed_tree)
